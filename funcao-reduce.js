...
const somaPopulacao = (populacao, cidades) => {
  const total = cidades.populacao;
  return populacao + total;
}

const totalPopulacao = cidadesDaEstonia.reduce(somaPopulacao, 0);
console.log(`\nTotal populacional das cidades: ${totalPopulacao} habitantes.\n`);